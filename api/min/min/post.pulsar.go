...
func init() {
	...
	md_Post = File_min_min_post_proto.Messages().ByName("Post")
...
func (x *Post) slowProtoReflect() protoreflect.Message {
	mi := &file_min_min_post_proto_msgTypes[0]
...
func (x *fastReflection_Post) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "min.min.Post.id":
		return x.Id != uint64(0)
	case "min.min.Post.title":
		return x.Title != ""
	case "min.min.Post.body":
		return x.Body != ""
	case "min.min.Post.creator":
		return x.Creator != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: min.min.Post"))
		}
		panic(fmt.Errorf("message min.min.Post does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Post) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message min.min.Post does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Post) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "min.min.Post.id":
		panic(fmt.Errorf("field id of message min.min.Post is not mutable"))
	case "min.min.Post.title":
		panic(fmt.Errorf("field title of message min.min.Post is not mutable"))
	case "min.min.Post.body":
		panic(fmt.Errorf("field body of message min.min.Post is not mutable"))
	case "min.min.Post.creator":
		panic(fmt.Errorf("field creator of message min.min.Post is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: min.min.Post"))
		}
...
func (x *fastReflection_Post) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in min.min.Post", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Post) Descriptor() ([]byte, []int) {
	return file_min_min_post_proto_rawDescGZIP(), []int{0}
}
...
var File_min_min_post_proto protoreflect.FileDescriptor

var file_min_min_post_proto_rawDesc = []byte{
	0x0a, 0x12, 0x6d, 0x69, 0x6e, 0x2f, 0x6d, 0x69, 0x6e, 0x2f, 0x70, 0x6f, 0x73, 0x74, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x6d, 0x69, 0x6e, 0x2e, 0x6d, 0x69, 0x6e, 0x22, 0x5a, 0x0a,
	...
	0x2e, 0x6d, 0x69, 0x6e, 0x2e, 0x6d, 0x69, 0x6e, 0x42, 0x09, 0x50, 0x6f, 0x73, 0x74, 0x50, 0x72,
	0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x18, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x73, 0x64, 0x6b,
	0x2e, 0x69, 0x6f, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x6d, 0x69, 0x6e, 0x2f, 0x6d, 0x69, 0x6e, 0xa2,
	0x02, 0x03, 0x4d, 0x4d, 0x58, 0xaa, 0x02, 0x07, 0x4d, 0x69, 0x6e, 0x2e, 0x4d, 0x69, 0x6e, 0xca,
	0x02, 0x07, 0x4d, 0x69, 0x6e, 0x5c, 0x4d, 0x69, 0x6e, 0xe2, 0x02, 0x13, 0x4d, 0x69, 0x6e, 0x5c,
	0x4d, 0x69, 0x6e, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea,
	0x02, 0x08, 0x4d, 0x69, 0x6e, 0x3a, 0x3a, 0x4d, 0x69, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}

var (
	file_min_min_post_proto_rawDescOnce sync.Once
	file_min_min_post_proto_rawDescData = file_min_min_post_proto_rawDesc
)

func file_min_min_post_proto_rawDescGZIP() []byte {
	file_min_min_post_proto_rawDescOnce.Do(func() {
		file_min_min_post_proto_rawDescData = protoimpl.X.CompressGZIP(file_min_min_post_proto_rawDescData)
	})
	return file_min_min_post_proto_rawDescData
}

var file_min_min_post_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_min_min_post_proto_goTypes = []interface{}{
	(*Post)(nil), // 0: min.min.Post
}
var file_min_min_post_proto_depIdxs = []int32{
...
func init() { file_min_min_post_proto_init() }
func file_min_min_post_proto_init() {
	if File_min_min_post_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_min_min_post_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Post); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_min_min_post_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_min_min_post_proto_goTypes,
		DependencyIndexes: file_min_min_post_proto_depIdxs,
		MessageInfos:      file_min_min_post_proto_msgTypes,
	}.Build()
	File_min_min_post_proto = out.File
	file_min_min_post_proto_rawDesc = nil
	file_min_min_post_proto_goTypes = nil
	file_min_min_post_proto_depIdxs = nil
}
