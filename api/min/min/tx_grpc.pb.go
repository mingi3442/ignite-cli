...
const (
	Msg_UpdateParams_FullMethodName = "/min.min.Msg/UpdateParams"
	Msg_CreatePost_FullMethodName   = "/min.min.Msg/CreatePost"
	Msg_UpdatePost_FullMethodName   = "/min.min.Msg/UpdatePost"
	Msg_DeletePost_FullMethodName   = "/min.min.Msg/DeletePost"
)
